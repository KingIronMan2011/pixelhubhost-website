<<<<<<< HEAD:dist/assets/UnderConstruction-DHyAMO_i.js
import {
  i as c,
  l as x,
  j as e,
  ...
  b as w,
  d as f,
} from './index-CKc9R_qi.js';
const h = s.name,
  r = s.contact,
  y = s.website,
  v = () => {
    var d;
    const n = c.language || 'en',
      ...
      u = (p) => {
        c.changeLanguage(p.target.value);
      };
        ...
        e.jsxs('div', {
          ...
          children: [
            e.jsxs('div', {
              ...
              children: [
                e.jsxs('a', {
                  ...
                  children: [
                    e.jsx(g, { size: 28, className: 'text-indigo-500 drop-shadow' }),
                    e.jsx('span', {
                      className:
            ...
            e.jsxs('footer', {
              ...
              children: [
                e.jsx(g, { size: 14, className: 'inline-block mb-0.5 text-indigo-400' }),
