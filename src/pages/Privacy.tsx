...
const privacyTexts = {
  ...
  intro: {
    ...
    it: "Prendiamo sul serio la tua privacy. Questa pagina spiega quali dati raccogliamo e come li utilizziamo.",
  },
  data: {
    ...
    it: "Raccogliamo solo i dati necessari per fornire i nostri servizi. Questi possono includere il tuo indirizzo email, nome utente e dati di utilizzo.",
  },
  cookies: {
    ...
    it: "Potremmo utilizzare i cookie per migliorare la tua esperienza. Puoi disabilitare i cookie nelle impostazioni del tuo browser.",
  },
  thirdParty: {
    ...
    it: "Non condividiamo i tuoi dati con terze parti se non richiesto dalla legge o per fornire i nostri servizi.",
  },
  contact: {
    ...
    it: "Se hai domande sulla nostra informativa sulla privacy, ti preghiamo di contattarci.",
  },
};
